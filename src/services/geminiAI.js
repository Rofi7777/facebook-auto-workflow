...
請分析並回傳雙語JSON格式：`
  ...
  generateScenarioDetails(scenarioType, modelNationality = 'taiwan', modelCombination = 'parents_baby', sceneLocation = 'park') {
    ...
    const scenarioMap = {
      '親子互動': {
        ...
        specificRequirements: '- Focus on bonding and connection between family members\n- Show active engagement and interaction\n- Warm, nurturing atmosphere',
      ...
      '居家遊戲': {
        ...
        specificRequirements: '- Comfortable environment\n- Daily play routine atmosphere\n- Organized, family-friendly space',
  ...
  async generateMarketingImage(prompt, imagePath, productImagePath = null, scenarioType = '親子互動', modelNationality = 'taiwan', modelCombination = 'parents_baby', sceneLocation = 'park') {
    try {
